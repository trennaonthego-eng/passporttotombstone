...
- **Partnerships page** (`/partnerships`) — Free / Featured $49 / Premium $99 / Newsletter Sponsor $25, each tier's CTA goes to `/upgrade`, plus FAQ
...
- **Business detail pages** (`/business/[id]`) — one page per business split into "The Building" (honest historic context) and "Today" (current business info); stays live for every business (AI SEO), but only linked from listing cards for Premium partners — everyone else's card links to their own website
...
3. **Product catalog → Add product** — create three, each with a **recurring**
   ...
   - "Premium Story Partner" — $99.00/month → → `STRIPE_PRICE_PREMIER`
...
- **Tiers are pay-to-play** — only Silver Spur Homestead and Team Franko carry
  Premium badges; every other listing is a free Story Partner. When a business
